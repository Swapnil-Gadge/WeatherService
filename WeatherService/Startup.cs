...
namespace WeatherService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IAuthentiationService, AuthentiationService>();
            services.AddTransient<IWeatherService, WeathersService>();
            services.AddTransient<IModelToTextConverter, ModelToTextConverter>();
